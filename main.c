...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE hPrev, LPSTR lpCmd, int nShow) {
    ...
    // 2. Initialize the editor state based on command line arguments
    // Note: __argc and __argv are MSVC-specific. For strict portability, 
    // consider using CommandLineToArgvW(GetCommandLineW(), &argc).
    ...
    wc.hbrBackground = NULL; // Background is explicitly handled in WM_ERASEBKGND / WM_PAINT
