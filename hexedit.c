...
// Snaps the window height to perfectly fit an exact number of text rows
void SnapWindowSize(HWND hwnd, int rows) {
    ...
    int target_win_width = (client_rect.right - client_rect.left) + frame_width;
    
    SetWindowPos(hwnd, NULL, win_rect.left, win_rect.top, target_win_width, target_win_height, SWP_NOZORDER);
}
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    switch (msg) {
        case WM_CREATE:
            ...
            // Requirement: Always start with exactly 16 rows
        ...
        case WM_PAINT: {
            ...
            if (menu_visible) {
                ...
                // Requirement: Show filename in title like [file.jpg]
